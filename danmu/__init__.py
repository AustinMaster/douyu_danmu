...
class DanMuClient(object):
    def __init__(self, url):
        ...
        if 'http://' == url[:7]:
            ...
            self.__url = 'http://' + url
        for u, bc in {
                'douyu.com'         : DouYuDanMuClient, }.items() :
    ...
    def gift(self, fn):
        ...
        return fn
    def anbc(self, fn):
        self.__register(fn, 'anbc')
        return fn
    def rnewbc(self, fn):
        self.__register(fn, 'rnewbc')
        return fn
    def tsgs(self, fn):
        self.__register(fn, 'tsgs')
        return fn
    def noble_num_info(self, fn):
        self.__register(fn, 'noble_num_info')
        return fn
    def online_noble_list(self, fn):
        self.__register(fn, 'online_noble_list')
        return fn
    def synexp(self, fn):
        self.__register(fn, 'synexp')
        return fn
    def other(self, fn):
